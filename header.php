...
<div id="page" class="site min-h-screen flex flex-col">
    <a class="skip-link screen-reader-text sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 bg-blue-600 text-white p-2 z-50" href="#primary">
        <?php esc_html_e('Skip to content', 'mcqhome'); ?>
    </a>
            ...
            <div class="flex items-center justify-between py-4">
                ...
                <nav id="site-navigation" class="main-navigation hidden md:block">
                    ...
                    wp_nav_menu([
                        ...
                        'fallback_cb'    => 'mcqhome_default_menu',
                    ]);
                    ?>
                </nav>
