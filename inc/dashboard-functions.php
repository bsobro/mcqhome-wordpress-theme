...
function mcqhome_render_student_dashboard($user_id) {
    ...
    <div class="student-dashboard">
        ...
        <!-- Quick Stats -->
        <div class="dashboard-stats grid gap-4 sm:gap-6 mb-6 lg:mb-8">
            <?php
            $stats = mcqhome_get_student_stats($user_id);
            ?>
            
            <!-- Enrolled Courses -->
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-6 h-6 sm:w-8 sm:h-8 bg-blue-100 rounded-md flex items-center justify-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Enrolled Courses', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900 stat-enrolled-courses"><?php echo $stats['enrolled_courses']; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-6 h-6 sm:w-8 sm:h-8 bg-green-100 rounded-md flex items-center justify-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Completed MCQs', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900 stat-completed-mcqs"><?php echo $stats['completed_mcqs']; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-6 h-6 sm:w-8 sm:h-8 bg-yellow-100 rounded-md flex items-center justify-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Average Score', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900 stat-average-score"><?php echo $stats['average_score']; ?>%</p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-6 h-6 sm:w-8 sm:h-8 bg-purple-100 rounded-md flex items-center justify-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Following', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900 stat-following-count"><?php echo $stats['following_count']; ?></p>
                    </div>
                </div>
            </div>
        </div>

        <div class="dashboard-main-layout grid gap-6 lg:gap-8">
            
            <!-- Main Content Area -->
            <div class="dashboard-main-content space-y-6 lg:space-y-8">
                
                <!-- Enrolled Courses Overview -->
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('My Enrolled Courses', 'mcqhome'); ?></h2>
                    </div>
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Recent Activity', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Progress Overview', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
            ...
            <!-- Sidebar -->
            <div class="dashboard-sidebar space-y-6 lg:space-y-8">
                
                <!-- Personalized Content Feed -->
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Latest from Following', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 flex items-center justify-between">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Notifications', 'mcqhome'); ?></h2>
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Following', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Performance Analytics', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
...
function mcqhome_render_enrolled_courses($user_id) {
    ...
    foreach ($mcq_sets as $set) {
        ...
        echo '<div class="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">';
        echo '<div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">';
        echo '<div class="flex-1">';
        echo '<h3 class="text-base sm:text-lg font-medium text-gray-900">';
        echo '<a href="' . get_permalink($set->ID) . '" class="hover:text-blue-600">' . esc_html($set->post_title) . '</a>';
        echo '</h3>';
        
        echo '<div class="mt-1 text-xs sm:text-sm text-gray-500">';
        if ($institution) {
            echo '<span class="inline-flex items-center">';
            echo '<svg class="w-3 h-3 sm:w-4 sm:h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">';
        ...
        // Action buttons
        echo '<div class="flex-shrink-0 sm:ml-4">';
        if ($progress['percentage'] > 0) {
            echo '<a href="' . get_permalink($set->ID) . '?action=continue" class="inline-flex items-center justify-center px-3 py-2 border border-transparent text-xs sm:text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 min-w-[80px]">';
            echo __('Continue', 'mcqhome');
            echo '</a>';
        } else {
            echo '<a href="' . get_permalink($set->ID) . '?action=start" class="inline-flex items-center justify-center px-3 py-2 border border-transparent text-xs sm:text-sm leading-4 font-medium rounded-md text-blue-600 bg-blue-100 hover:bg-blue-200 min-w-[80px]">';
    ...
    <div class="teacher-dashboard">
        ...
        <div class="dashboard-stats grid gap-4 sm:gap-6 mb-6 lg:mb-8">
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('MCQ Sets', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900"><?php echo $stats['mcq_sets']; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Total MCQs', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900"><?php echo $stats['total_mcqs']; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Students', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900"><?php echo $stats['students']; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Followers', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900"><?php echo $stats['followers']; ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="dashboard-main-layout grid gap-6 lg:gap-8">
            ...
            <div class="dashboard-main-content space-y-6 lg:space-y-8">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Quick Actions', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <a href="<?php echo admin_url('post-new.php?post_type=mcq'); ?>" class="btn-primary inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                                <?php _e('Create New MCQ', 'mcqhome'); ?>
                            </a>
                            <a href="<?php echo admin_url('post-new.php?post_type=mcq_set'); ?>" class="btn-secondary inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-gray-700 bg-gray-100 hover:bg-gray-200">
                                <?php _e('Create MCQ Set', 'mcqhome'); ?>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Recent MCQ Sets', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                        <p class="text-gray-500"><?php _e('Your recent MCQ sets will appear here.', 'mcqhome'); ?></p>
                    </div>
                </div>
            ...
            <div class="dashboard-sidebar space-y-6 lg:space-y-8">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Institution', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                        <?php
                        $institution_id = get_user_meta($user_id, 'institution_id', true);
                        if ($institution_id) {
                            $institution = get_post($institution_id);
                            if ($institution) {
                                echo '<p class="font-medium">' . esc_html($institution->post_title) . '</p>';
                            } else {
                                echo '<p class="text-gray-500">' . __('MCQ Academy', 'mcqhome') . '</p>';
                            }
                        } else {
                            echo '<p class="text-gray-500">' . __('MCQ Academy', 'mcqhome') . '</p>';
                        }
...
function mcqhome_render_institution_dashboard($user_id) {
    ...
    <div class="institution-dashboard">
        ...
        <div class="dashboard-stats grid gap-4 sm:gap-6 mb-6 lg:mb-8">
            <?php
            // Get institution post ID for this user
            $institution_posts = get_posts([
                'post_type' => 'institution',
                'author' => $user_id,
                'posts_per_page' => 1,
                'post_status' => 'publish'
            ...
            $institution_id = !empty($institution_posts) ? $institution_posts[0]->ID : 0;
            $stats = $institution_id ? mcqhome_get_institution_stats($institution_id) : [
                'teachers' => 0,
                'mcq_sets' => 0,
                'total_mcqs' => 0,
                'followers' => 0
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Teachers', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900"><?php echo $stats['teachers']; ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="dashboard-main-layout grid gap-6 lg:gap-8">
            ...
            <div class="dashboard-main-content space-y-6 lg:space-y-8">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Institution Management', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                        <p class="text-gray-500"><?php _e('Manage your institution settings and content.', 'mcqhome'); ?></p>
                    </div>
                </div>
            ...
            <div class="dashboard-sidebar space-y-6 lg:space-y-8">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Institution Profile', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                        <?php
                        if ($institution_id) {
                            ...
                            echo '<p class="text-gray-500">' . __('No institution profile found.', 'mcqhome') . '</p>';
                        }
                        ?>
                    </div>
                </div>
 ...
 */
function mcqhome_render_admin_dashboard($user_id) {
    ?>
    <div class="admin-dashboard">
        ...
        <div class="dashboard-stats grid gap-4 sm:gap-6 mb-6 lg:mb-8">
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Total Users', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900"><?php echo $stats['total_users']; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('MCQ Sets', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900"><?php echo $stats['total_mcq_sets']; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card bg-white rounded-lg shadow-sm p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 sm:ml-4">
                        <p class="text-xs sm:text-sm font-medium text-gray-500"><?php _e('Institutions', 'mcqhome'); ?></p>
                        <p class="text-lg sm:text-2xl font-semibold text-gray-900"><?php echo $stats['total_institutions']; ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="dashboard-main-layout grid gap-6 lg:gap-8">
            ...
            <div class="dashboard-main-content space-y-6 lg:space-y-8">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('System Overview', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                        <p class="text-gray-500"><?php _e('Platform administration and management tools.', 'mcqhome'); ?></p>
                        <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <a href="<?php echo admin_url('users.php'); ?>" class="btn-primary inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                                <?php _e('Manage Users', 'mcqhome'); ?>
                            </a>
                            <a href="<?php echo admin_url('edit.php?post_type=mcq_set'); ?>" class="btn-secondary inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-gray-700 bg-gray-100 hover:bg-gray-200">
                                <?php _e('Manage Content', 'mcqhome'); ?>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="dashboard-sidebar space-y-6 lg:space-y-8">
                ...
                <div class="dashboard-section bg-white rounded-lg shadow-sm">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h2 class="text-base sm:text-lg font-semibold text-gray-900"><?php _e('Quick Links', 'mcqhome'); ?></h2>
                    </div>
                    <div class="p-4 sm:p-6">
                        <ul class="space-y-2">
                            <li><a href="<?php echo admin_url(); ?>" class="text-blue-600 hover:text-blue-500"><?php _e('WordPress Admin', 'mcqhome'); ?></a></li>
                            <li><a href="<?php echo admin_url('themes.php'); ?>" class="text-blue-600 hover:text-blue-500"><?php _e('Theme Settings', 'mcqhome'); ?></a></li>
                            <li><a href="<?php echo admin_url('plugins.php'); ?>" class="text-blue-600 hover:text-blue-500"><?php _e('Plugins', 'mcqhome'); ?></a></li>
                        </ul>
                    </div>
                </div>
...
function mcqhome_get_activity_feed($user_id, $limit = 10) {
    ...
    // Get followed institutions and teachers
    $following_institutions = get_user_meta($user_id, 'following_institutions', true);
    $following_teachers = get_user_meta($user_id, 'following_teachers', true);
    
    if (!is_array($following_institutions)) $following_institutions = [];
    if (!is_array($following_teachers)) $following_teachers = [];
    ...
    // Get recent posts from followed institutions
    if (!empty($following_institutions)) {
        $institution_posts = get_posts([
        ...
        foreach ($institution_posts as $post) {
            $activities[] = (object) [
    ...
    // Get recent posts from followed teachers
    if (!empty($following_teachers)) {
        $teacher_posts = get_posts([
            'post_type' => ['mcq', 'mcq_set'],
            'posts_per_page' => $limit,
            'author__in' => $following_teachers,
            'orderby' => 'date',
            'order' => 'DESC'
        ]);
...
function mcqhome_render_notifications($user_id) {
    ...
    echo '<div class="text-center py-8">';
    echo '<svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">';
    echo '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5v-5zM11 17H6l5 5v-5zM12 3v12"></path>';
    echo '</svg>';
    echo '<h3 class="mt-2 text-sm font-medium text-gray-900">' . __('No notifications', 'mcqhome') . '</h3>';
    echo '<p class="mt-1 text-sm text-gray-500">' . __('You\'ll see notifications here when there are updates.', 'mcqhome') . '</p>';
    echo '</div>';
}
...
function mcqhome_render_following_management($user_id) {
    ...
    if ($total_following === 0) {
        ...
        echo '</svg>';
        echo '<h3 class="mt-2 text-sm font-medium text-gray-900">' . __('Not following anyone', 'mcqhome') . '</h3>';
        echo '<p class="mt-1 text-sm text-gray-500">' . __('Start following institutions and teachers to see their content.', 'mcqhome') . '</p>';
        echo '<div class="mt-6">';
        echo '<a href="' . home_url('/institutions/') . '" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">';
        echo __('Browse Institutions', 'mcqhome');
        echo '</a>';
    ...
    if (!empty($following_institutions)) {
        ...
        foreach ($institutions as $institution) {
            echo '<div class="following-item flex items-center justify-between py-2 border-b border-gray-100">';
            echo '<div class="flex items-center">';
            echo '<div class="following-avatar w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mr-3">';
            echo '<span class="text-xs font-medium text-blue-600">' . substr($institution->post_title, 0, 1) . '</span>';
            echo '</div>';
            echo '<div class="following-info">';
            echo '<div class="following-name text-sm font-medium text-gray-900">' . esc_html($institution->post_title) . '</div>';
            echo '<div class="following-type text-xs text-gray-500">' . __('Institution', 'mcqhome') . '</div>';
            echo '</div>';
            echo '</div>';
            echo '<button class="unfollow-btn text-xs text-red-600 hover:bg-red-50 px-2 py-1 rounded" data-institution-id="' . $institution->ID . '">';
            echo __('Unfollow', 'mcqhome');
            echo '</button>';
            echo '</div>';
        }
    ...
    if (!empty($following_teachers)) {
        $teachers = get_users([
            'include' => array_slice($following_teachers, 0, 5),
        ...
        foreach ($teachers as $teacher) {
            echo '<div class="following-item flex items-center justify-between py-2 border-b border-gray-100">';
            echo '<div class="flex items-center">';
            echo '<div class="following-avatar w-8 h-8 bg-green-100 rounded-full flex items-center justify-center mr-3">';
            echo '<span class="text-xs font-medium text-green-600">' . substr($teacher->display_name, 0, 1) . '</span>';
            echo '</div>';
            echo '<div class="following-info">';
            echo '<div class="following-name text-sm font-medium text-gray-900">' . esc_html($teacher->display_name) . '</div>';
            echo '<div class="following-type text-xs text-gray-500">' . __('Teacher', 'mcqhome') . '</div>';
            echo '</div>';
            echo '</div>';
            echo '<button class="unfollow-btn text-xs text-red-600 hover:bg-red-50 px-2 py-1 rounded" data-teacher-id="' . $teacher->ID . '">';
            echo __('Unfollow', 'mcqhome');
            echo '</button>';
            echo '</div>';
        }
...
function mcqhome_render_performance_analytics($user_id) {
    ...
    if (!$performance_data || $performance_data->total_attempts == 0) {
        echo '<div class="text-center py-8">';
        echo '<svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">';
        echo '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>';
        echo '</svg>';
        echo '<h3 class="mt-2 text-sm font-medium text-gray-900">' . __('No performance data', 'mcqhome') . '</h3>';
        echo '<p class="mt-1 text-sm text-gray-500">' . __('Complete some MCQs to see your performance analytics.', 'mcqhome') . '</p>';
        echo '</div>';
        return;
    }
    ...
    // Performance summary
    echo '<div class="grid grid-cols-2 gap-4 text-center">';
    
    echo '<div class="bg-gray-50 rounded-lg p-3">';
    echo '<div class="text-lg font-semibold text-gray-900">' . round($performance_data->avg_score, 1) . '%</div>';
    echo '<div class="text-xs text-gray-500">' . __('Average Score', 'mcqhome') . '</div>';
    echo '</div>';
    
    echo '<div class="bg-gray-50 rounded-lg p-3">';
    echo '<div class="text-lg font-semibold text-gray-900">' . round($performance_data->best_score, 1) . '%</div>';
    echo '<div class="text-xs text-gray-500">' . __('Best Score', 'mcqhome') . '</div>';
    echo '</div>';
    ...
    $score_color = $performance_data->avg_score >= 70 ? 'bg-green-500' : ($performance_data->avg_score >= 50 ? 'bg-yellow-500' : 'bg-red-500');
    
    echo '<div class="mt-4">';
    echo '<div class="flex items-center justify-between text-sm mb-2">';
    echo '<span class="text-gray-600">' . __('Overall Performance', 'mcqhome') . '</span>';
    echo '<span class="font-medium">' . round($performance_data->avg_score, 1) . '%</span>';
    echo '</div>';
    echo '<div class="w-full bg-gray-200 rounded-full h-2">';
    echo '<div class="' . $score_color . ' h-2 rounded-full" style="width: ' . $performance_data->avg_score . '%"></div>';
    echo '</div>';
    echo '</div>';
